function wrapper() {
    try {
        const SwagCmsExtensionsQuickview = window.PluginManager.getPlugin('SwagCmsExtensionsQuickview').get('class');

        class CmsExtensionsQuickviewOptions extends SwagCmsExtensionsQuickview {
            static options = {
        ...
        return CmsExtensionsQuickviewOptions
    } catch (e) {}
}
