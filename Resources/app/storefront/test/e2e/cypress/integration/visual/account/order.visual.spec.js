...
describe('Account: Order page', () => {
    ...
    it('@visual: reorder order', () => {
        ...
        cy.takeSnapshot('[Order] Re-order - Add product to shopping cart', {widths: [375, 768, 1920]});
        ...
        cy.takeSnapshot('[Order] Re-order - Confirm order page', {widths: [375, 768, 1920]});
    ...
    it('@visual: cancel order', () => {
        ...
        cy.takeSnapshot('[Order] Order actions', {widths: [375, 768, 1920]});

        cy.get('.dropdown-menu > [type="button"]').click();
        cy.get('.order-history-cancel-modal').should('be.visible');
        cy.takeSnapshot('[Order] Order History Cancel Modal', {widths: [375, 768, 1920]});
    ...
    it('@visual: change payment', () => {
        ...
        cy.takeSnapshot('[Order] Change payment method', {widths: [375, 768, 1920]});
